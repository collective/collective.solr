...
class ISolrSchema(Interface):
    ...
    host = TextLine(
        ...
        description=_(
            "help_host", default=u"The host name of the Solr instance to be used."
        ),
    )
    ...
    base = TextLine(
        ...
        description=_(
            "help_base", default=u"The base prefix of the Solr instance to be used."
        ),
    )
    ...
    search_pattern = Text(
        title=_("label_search_pattern", default=u"Pattern for simple search queries"),
        description=_(
            "help_search_pattern",
    ...
    exclude_user = Bool(
        title=_(
            "label_exclude_user", default=u"Exclude user from allowedRolesAndUsers"
        ),
        description=_(
            "help_exclude_user",
    ...
    highlight_formatter_pre = TextLine(
        title=_("label_highlight_formatter_pre", default=u"Highlight formatter: pre"),
        description=_(
    ...
    highlight_formatter_post = TextLine(
        title=_("label_highlight_formatter_post", default=u"Highlight formatter: post"),
        description=_(
    ...
    highlight_fragsize = Int(
        title=_("label_highlight_fragsize", default=u"Highlight Fragment Size"),
        description=_(
    ...
    field_list = List(
        ...
        description=_(
            "help_field_list",
            default=(
                u"Specify metadata fields that should be returned for "
    ...
    boost_script = Text(
        title=_(
            "label_boost_script", default=u"Python script for custom index boosting"
        ),
        required=False,
        default=u"",
        missing_value=u"",
