...
class ParseDateHelperTests(TestCase):
    def testParseDateHelper(self):
        self.assertEqual(
            parseDate("2007-08-11T00:00:00.000Z").ISO8601(),
            DateTime(2007, 8, 11, 0, 0, 0, "GMT").ISO8601(),
        )
        self.assertEqual(
            parseDate("1900-01-01T00:00:00.000Z").ISO8601(),
            DateTime(1900, 1, 1, 0, 0, 0, "GMT").ISO8601(),
        )
        self.assertEqual(
            parseDate("999-12-31T00:00:00.000Z").ISO8601(),
            DateTime(999, 12, 31, 0, 0, 0, "GMT").ISO8601(),
        )
        self.assertEqual(
            parseDate("99-12-31T00:00:00.000Z").ISO8601(),
