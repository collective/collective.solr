...
class QueryManglerTests(TestCase):
    ...
    def testDateConversion(self):
        ...
        self.assertEqual(
            keywords, {"foo": "[1972-05-11T00:00:00.000Z TO 1972-05-18T00:00:00.000Z]"}
        )
    ...
    def testOperatorConversion(self):
        ...
        self.assertEqual(
            keywords, {"foo": "(1972-05-11T00:00:00.000Z OR 1972-05-18T00:00:00.000Z)"}
        )
...
class QueryParameterTests(TestCase):
    ...
    def testCombined(self):
        ...
        params = extract({"sort_on": "foo", "sort_order": "reverse", "sort_limit": 5})
    ...
    def testAllowDistanceParameter(self):
