...
class QuoteTests(TestCase):
    ...
    def testQuotingRangeSearches(self):
        ...
        self.assertEqual(
            quote("[1972-05-11T00:00:00.000Z TO *]"), "[1972-05-11T00:00:00.000Z TO *]"
        )
        self.assertEqual(
            quote("[1972-05-11T00:00:00.000Z TO " "2011-05-10T01:30:00.000Z]"),
    ...
    def testQuotingOperatorsGrouping(self):
        ...
        self.assertEqual(
            quote('"jakarta apache" OR jakarta'), '("jakarta apache" OR jakarta)'
        )
        self.assertEqual(
        ...
        self.assertEqual(quote("((a AND b) OR c)"), "((a AND b) OR c)")
        self.assertEqual(
            quote('"jakarta apache" || jakarta'), '("jakarta apache" || jakarta)'
        )
        self.assertEqual(
            quote('"jakarta apache" && "Apache Lucene"'),
            '("jakarta apache" && "Apache Lucene")',
        ...
        self.assertEqual(
            quote("(jakarta || apache) && website"), "((jakarta || apache) && website)"
        )
    ...
    def testSolrSpecifics(self):
        ...
        self.assertEqual(quote("[* TO NOW]"), "[* TO NOW]")
        self.assertEqual(
            quote("[1976-03-06T23:59:59.999Z TO *]"), "[1976-03-06T23:59:59.999Z TO *]"
        )
        self.assertEqual(
            quote("[1995-12-31T23:59:59.999Z TO " "2007-03-06T00:00:00Z]"),
        ...
        self.assertEqual(
            quote("[1976-03-06T23:59:59.999Z TO " "1976-03-06T23:59:59.999Z+1YEAR]"),
            "[1976-03-06T23:59:59.999Z TO " "1976-03-06T23:59:59.999Z+1YEAR]",
        )
        # quoting date operators seems to be ok too
        self.assertEqual(
            quote("[1976-03-06T23:59:59.999Z/YEAR TO " "1976-03-06T23:59:59.999Z]"),
...
class QueryTests(TestCase):
    ...
    def testMultiArgumentQueries(self):
        ...
        self.assertEqual(bq("foo", name=("bar", "hmm")), "+foo +name:(bar OR hmm)")
        self.assertEqual(
            bq("foo", name=("foo bar", "hmm")), '+foo +name:("foo bar" OR hmm)'
        )
        ...
        self.assertEqual(
            bq(name="foo", cat=["foo bar", "hmm"]), '+cat:("foo bar" OR hmm) +name:foo'
        )
...
class SearchTests(TestCase):
    ...
    def testSimpleSearch(self):
        ...
        self.assertIn(
            normalize(output.get(skip=1)), [normalize(request), normalize(request_py2)]
        )
